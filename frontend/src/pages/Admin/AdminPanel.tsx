...
const AdminPanel: React.FC = () => {
  ...
  const statsData = [
    ...
    { 
      label: 'Room Bookings', 
      value: stats.roomBookings.toString(), 
      change: '+12%', 
      icon: BedDouble,
    ...
    { 
      ...
      value: stats.banquetBookings.toString(), 
      change: '+8%', 
      icon: Building,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="flex">
        {/* Sidebar */}
        <div className={`${sidebarOpen ? 'w-64' : 'w-20'} bg-gradient-to-b from-gray-900 to-gray-800 shadow-2xl transition-all duration-300 relative`}>
                ...
                {sidebarOpen && (
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <span className="text-xs text-gray-400">J.N Palace Hotel</span>
                    </div>
                  </div>
                )}
                <button
              ...
              {menuItems.map((item) => {
                ...
                return (
                  <Link
                    key={item.id}
                    to={item.path}
                    className={`flex items-center px-4 py-3 mb-1 rounded-lg text-sm font-medium transition-all duration-200 group ${
                      isActive
                ...
                <div>
                  ...
                  <div className="mb-8">
                    ...
                    <p className="text-gray-600 flex items-center">
                      ...
                      Live overview of hotel operations
                    </p>
                  </div>
                        ...
                        >
                          ...
                          <div className="p-6">
                            <div className="flex items-center justify-between mb-4">
                              <div className={`${stat.lightBg} p-3 rounded-lg group-hover:scale-110 transition-transform duration-300`}>
                                <Icon className={`h-6 w-6 ${stat.textColor}`} />
                              </div>
                              <span className={`text-sm font-semibold ${stat.textColor} flex items-center`}>
                    ...
                    <div className="flex justify-between items-center mb-6">
                      ...
                      <div className="flex items-center space-x-4">
                        ...
                        <div className="flex items-center">
                          ...
                          <span className="text-sm text-gray-600">Banquets</span>
                        </div>
                        <div className="flex items-center">
                    ...
                    {bookingChartData.length > 0 ? (
                      ...
                      <div className="h-80 flex items-center justify-center">
                        <div className="text-center">
                          ...
                          <p className="text-gray-500 font-medium">Loading booking data...</p>
                        </div>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
                      <div className="flex items-center justify-between mb-6">
                        <div>
                          ...
                          <p className="text-sm text-gray-500">Latest customer reservations</p>
                        </div>
                        <Link 
                          to="/admin/bookings"
                    ...
                    <div className="bg-gradient-to-br from-blue-600 to-purple-600 rounded-xl shadow-lg p-6 text-white">
                      <div className="mb-6">
                        ...
                        <p className="text-blue-100 text-sm">Manage your hotel efficiently</p>
                      </div>
                      <div className="grid grid-cols-2 gap-3">
                        <Link 
                          to="/admin/rooms"
                          className="bg-white/10 backdrop-blur-sm hover:bg-white/20 py-4 px-4 rounded-lg transition-all duration-200 flex flex-col items-center justify-center group"
                        >
                          <BedDouble className="h-6 w-6 mb-2 group-hover:scale-110 transition-transform" />
                        ...
                        <Link 
                          ...
                          className="bg-white/10 backdrop-blur-sm hover:bg-white/20 py-4 px-4 rounded-lg transition-all duration-200 flex flex-col items-center justify-center group"
                        >
                          <Utensils className="h-6 w-6 mb-2 group-hover:scale-110 transition-transform" />
                        ...
                        <Link 
                          ...
                          className="bg-white/10 backdrop-blur-sm hover:bg-white/20 py-4 px-4 rounded-lg transition-all duration-200 flex flex-col items-center justify-center group"
                        >
                          <MessageSquare className="h-6 w-6 mb-2 group-hover:scale-110 transition-transform" />
